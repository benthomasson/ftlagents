...
from smolagents.monitoring import YELLOW_HEX, AgentLogger, LogLevel, Monitor
...
from ftlagents.local_python_executor import (
    BASE_BUILTIN_MODULES,
    LocalPythonInterpreter,
    fix_final_answer_code,
)
from ftlagents.memory import ActionStep
    ...
    def step(self, memory_step: ActionStep) -> Union[None, Any]:
        ...
        try:
            ...
            if model_message.tool_calls is None or len(model_message.tool_calls) == 0:
                raise Exception(
                    "Model did not call any tools. Call `complete` tool to finish the task."
                )
